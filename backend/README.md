...
## Project Structure
    ...
    ├── tourism_template_38064  # Django project configurations
...
1. Clone this repo and `cd tourism_template_38064`
...
2. Clone this repo and `cd tourism_template_38064`
